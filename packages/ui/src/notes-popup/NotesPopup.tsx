...
export const NotesPopup = ({ notes, onCreateNote, onUpdateNote, onDeleteNote }: Props) => (
	<div className={classes.wrapper}>
		...
		<main className={classes.notesWrapper}>
			<div className={classes.createBox}>
				<div className={classes.createBtn} onClick={() => onCreateNote({ title: 'test', content: 'test test' })}></div>
			</div>
			<NotesList
				notes={notes}
